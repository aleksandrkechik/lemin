...
SRC_PATH = ./src/
SRCS = src/bring_balance_to_the_force_not_destroy_it.c src/gnl.c src/main.c src/read_input.c src/read_input1.c src/read_input2.c src/roomlist.c src/roomlist_2.c src/room.c src/room_2.c src/process_room.c src/dijkstra.c src/dijkstra_2.c src/dijkstra_3.c src/suurballe.c src/suurballe_2.c src/route.c src/route_2.c src/ants.c src/ants_2.c src/farm.c src/farm_2.c src/freeing_stuff.c src/links_from_in_to_out_and_route_parts.c
